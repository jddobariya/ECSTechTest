      ...
      <div>
        <Paper style={paperStyle} zDepth={2}>
          ...
          <Paper style={answerStyle}>
            <TextField name="submit-1" data-test-id={"submit-1"} hintStyle={rowStyle} hintText="submit challenge 1" underlineShow={false} onChange={(event, value) => this.handleText(event, value, 'answer-1')}/>
            <Divider />
            <TextField name="submit-2" data-test-id={"submit-2"} hintStyle={rowStyle} hintText="submit challenge 2" underlineShow={false} onChange={(event, value) => this.handleText(event, value, 'answer-2')}/>
            <Divider />
            <TextField name="submit-3" data-test-id={"submit-3"} hintStyle={rowStyle} hintText="submit challenge 3" underlineShow={false} onChange={(event, value) => this.handleText(event, value, 'answer-3')}/>
            <Divider />            
            <TextField name="submit-4" data-test-id={"submit-4"} hintStyle={rowStyle} hintText="Your Name" underlineShow={false} onChange={(event, value) => this.handleText(event, value, 'challenger-name')}/>
          </Paper>
          ...
          <p>Good Luck!</p>
          <RaisedButton id="submit-answers" label="Submit Answers" primary={true} onClick={this.submitForm}/>
